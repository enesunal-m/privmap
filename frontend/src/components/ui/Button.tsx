  ...
  (
    ...
    const variants = {
      ...
      secondary: cn(
        ...
        "focus:ring-2 focus:ring-surface-500 focus:ring-offset-2 focus:ring-offset-surface-900"
      ),
      ghost: cn(
      ...
      danger: cn(
        ...
        "hover:bg-red-500",
        "focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-surface-900"
      ),
    };
